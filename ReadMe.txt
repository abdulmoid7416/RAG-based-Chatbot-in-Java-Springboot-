...
In this project, I collaborated with IBM CAS (Center for Advanced Studies) to develop a RAG-based chatbot in Java (Springboot) for a project named "Cognitive Telescope Network". 
